...
x_w_LE = 9   # ft (Root leading-edge of the wing)
...
eta_h = 0.97 # Horizontal stabalizer efficiency (Yechout)
L_f = 35.5 # Length of the fuselage in ft
w_f = 4.39 # Max width of the fuselage in ft
K_f = 0.344 # From NACA TR 711 based on approximate x_AC_w/L_f = 0.30 (See Figure 8)
SM = 0.40
...
CL_ah = LiftSlope(AR_h, eta_h, sweep_h, M) 
