...
#Cruise constraint (function of W/S) !NEEDS POWER CORRECTION
...
#Ceiling constraint (plot on vertical axis as horizontal line) !NEEDS POWER CORRECTION
def ceiling_constraint(e, AR, cd_0):
    k = 1 / (np.pi* e * AR)
    ceiling_constraint = 2*np.sqrt(k*cd_0)
    return ceiling_constraint

#Manuever constraint (function of W/S) !NEEDS POWER CORRECTION
def manuever_constraint(e, AR, v_cruise, R_turn, q, cd_0, wing_loading):
    k = 1 / (np.pi* e * AR)
    g = 32.2
